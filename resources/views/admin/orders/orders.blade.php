        	 ...
        	 <form action="{{ route('list.orders') }}" method="GET">
              <div class="row p-t-0">
                  ...
                  <div class="col-md-4 d-flex align-items-center">
                      <button type="submit" class="btn btn-sm btn-info m-r-15"><i class="ti-search"></i> Tìm kiếm</button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <ul class="list list-unstyled text-right">
                                        ...
                                        @endif
                                        @if($order->cod)
                                            <li><span style="color: red;">Thu COD: <i>{{ number_format($order->cod) }} Vnđ</i></span></li>
                                        @endif
                                    </ul>
                                </div>
                            </div>
