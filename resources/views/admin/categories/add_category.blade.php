			    ...
			    <div class="card">
			        ...
			        <div class="card-block">
			            ...
			            <div class="form-group row">
	                        <div class="col-sm-6">
	                        	<label>Name :</label>
	                           <input type="text" name="name" id="name" class="form-control pname {{$errors->has('name') ? 'is-invalid' : '' }}" placeholder="Enter Category">
	                           @if($errors->has('name'))
	                    ...
	                    <div class="form-group row">
	                        <div class="col-sm-6">
	                            ...
	                            <input type="text" name="description" id="code" class="form-control pamount {{$errors->has('description') ? 'is-invalid' : '' }}" placeholder="Enter Description">
	                    ...
	                    <div class="form-group row">
	                        ...
	                        <div class="col-sm-6">
	                        	<button type="submit" class="btn btn-primary" style="float: right;">Add New Category</button>
	                        </div>
	                    </div>
			        </div>
			    </div>
